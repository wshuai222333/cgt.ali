                ...
                <div class="row row-lg">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>带图标的按钮示例，您可以通过“
                                <a href="/components/basic/icons" data-pjax="">矢量图标</a>
                                ”页面来选择图标。
                            </p>
                            <div class="example example-buttons">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example example-buttons">
                                ...
                                <button type="button" class="btn btn-icon social-google-plus">
                                    <i class="fa fa-google-plus" aria-hidden="true"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="example-wrap margin-lg-0">
                            ...
                            <div class="example example-buttons">
                                <button type="button" class="btn btn-labeled social-wechat">
                                    <span class="btn-label"><i class="fa fa-wechat" aria-hidden="true"></i></span> 微信
                                </button>
                                <button type="button" class="btn btn-labeled social-qq">
                                    <span class="btn-label"><i class="fa fa-qq" aria-hidden="true"></i></span> QQ
                                </button>
                                <button type="button" class="btn btn-labeled social-weibo">
                                    <span class="btn-label"><i class="fa fa-weibo" aria-hidden="true"></i></span> 微博
                                </button>
                                <button type="button" class="btn btn-labeled social-facebook">
                                    <span class="btn-label"><i class="fa fa-facebook" aria-hidden="true"></i></span>
                                    Facebook
                                </button>
                                <button type="button" class="btn btn-labeled social-twitter">
                                    <span class="btn-label"><i class="fa fa-twitter" aria-hidden="true"></i></span>
                                    Twitter
                                </button>
                                <button type="button" class="btn btn-labeled social-google-plus">
                                    <span class="btn-label"><i class="fa fa-google-plus" aria-hidden="true"></i></span>
                                    Google+
                                </button>
                                <button type="button" class="btn btn-labeled social-linkedin">
                                    <span class="btn-label"><i class="fa fa-linkedin" aria-hidden="true"></i></span>
                                    Linkedin
                                </button>
                                <button type="button" class="btn btn-labeled social-flickr">
                                    <span class="btn-label"><i class="fa fa-flickr" aria-hidden="true"></i></span>
                                    Flickr
                                </button>
                                <button type="button" class="btn btn-labeled social-tumblr">
                                    <span class="btn-label"><i class="fa fa-tumblr" aria-hidden="true"></i></span>
                                    Tumblr
                                </button>
                            </div>
                        </div>
                                ...
                                <ul class="list-unstyled pull-left margin-right-15">
                                    <li>
                                        <button type="button" class="btn btn-labeled btn-lg social-wechat">
                                            <span class="btn-label"><i class="fa fa-wechat" aria-hidden="true"></i></span>
                                            微信
                                        </button>
                                    </li>
                                    <li>
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <button type="button" class="btn btn-icon btn-lg social-wechat">
                                            <i class="fa fa-wechat" aria-hidden="true"></i></button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-icon social-wechat">
                                            <i class="fa fa-wechat" aria-hidden="true"></i></button>
